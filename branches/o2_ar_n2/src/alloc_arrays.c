...
#ifdef AR_N2_O2
printf("Allocating ar,n2,o2\n");
mn_ar = alloc3d(NZ,NXMEM,NYMEM);
if(age == NULL) {
	fprintf(stderr,"not enough memory for mn_ar!\n");
	return 1;
}
mn_n2 = alloc3d(NZ,NXMEM,NYMEM);
if(mn_age == NULL) {
	fprintf(stderr,"not enough memory for mn_n2!\n");
	return 1;
}
mn_o2 = alloc3d(NZ,NXMEM,NYMEM);
if(mn_age == NULL) {
	fprintf(stderr,"not enough memory for mn_o2!\n");
	return 1;
}
ar = alloc3d(NZ,NXMEM,NYMEM);
if(age == NULL) {
	fprintf(stderr,"not enough memory for ar!\n");
	return 1;
}
o2 = alloc3d(NZ,NXMEM,NYMEM);
if(mn_age == NULL) {
	fprintf(stderr,"not enough memory for o2!\n");
	return 1;
}
n2 = alloc3d(NZ,NXMEM,NYMEM);
if(mn_age == NULL) {
	fprintf(stderr,"not enough memory for n2!\n");
	return 1;
}
