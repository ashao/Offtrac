...
void read_uvw(int imon, char *fieldtype)
{
	...
	float tmp3p[NZ+1][NYTOT][NXTOT];
	float tmp3n[NZ+1][NYTOT][NXTOT];
...
void read_var3d( char inpath[200], char varname[200], int imon, double data[NZ][NXMEM][NYMEM])
{
...
void read_var2d( char inpath[200], char varname[200], int imon, double data[NXMEM][NYMEM])
{
