...
#define fukulonidx 62
	...
	mla140=m+5;
	m=m+6;
    printf("Index of 131-I tracer m = %d\n",mi131);
    printf("Index of 134-Cs tracer m = %d\n",mcs134);
    printf("Index of 136-Cs tracer m = %d\n",mcs136);
    printf("Index of 137-Cs tracer m = %d\n",mcs137);
    printf("Index of 140-Ba tracer m = %d\n",mba140);
    printf("Index of 140-La tracer m = %d\n",mla140);
		for (k=0;k<=1;k++) {
