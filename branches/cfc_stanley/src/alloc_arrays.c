...
#ifdef CFC
printf("Allocating cfc11,cfc12,sf6\n");
...
if(mn_sf6 == NULL) {
	fprintf(stderr,"not enough memory for mn_sf62!\n");
	return 1;
}
cfc11 = alloc3d(NZ,NXMEM,NYMEM);
if(cfc11 == NULL) {
	fprintf(stderr,"not enough memory for cfc11!\n");
	return 1;
}
cfc12 = alloc3d(NZ,NXMEM,NYMEM);
if(cfc12 == NULL) {
	fprintf(stderr,"not enough memory for cfc12!\n");
	return 1;
}
sf6 = alloc3d(NZ,NXMEM,NYMEM);
if(sf6 == NULL) {
	fprintf(stderr,"not enough memory for sf6!\n");
	return 1;
}
